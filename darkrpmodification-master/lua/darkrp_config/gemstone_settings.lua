...
gemstone.config.topazprinttime				= 30
...
gemstone.config.amethystprinttime			= 30
...
gemstone.config.emeraldprinttime			= 30
...
gemstone.config.rubyprinttime				= 30
...
gemstone.config.sapphireprinttime			= 30